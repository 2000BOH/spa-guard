...
export const TAB_INFO: Record<string, { id: string; name: string; htmlName: string; title: string }> = {
  ...
  // 미화팀 전용 탭
  cTab1: { id: 'cTab1', name: '오픈 전', htmlName: '오픈 전', title: '오픈 전 대청소 (07:00~09:00)' },
  cTab2: { id: 'cTab2', name: '오전 순회', htmlName: '오전 순회', title: '오전 순회 및 취약구역 (09:00~12:00)' },
  cTab3: { id: 'cTab3', name: '오후 순회', htmlName: '오후 순회', title: '오후 순환 청소 (12:00~18:00)' },
  cTab4: { id: 'cTab4', name: '심화 점검', htmlName: '심화 점검', title: '주간/월간 심화 점검' }
};

export const DEPT_TABS_MAP: Record<DepartmentId, string[]> = {
  facilities: ['tab1', 'tab2', 'tab3', 'tab4', 'tab5'],
  reception: [], // 추가 필요
  cleaning: ['cTab1', 'cTab2', 'cTab3', 'cTab4'],
  food: [],      // 추가 필요
  snack: []      // 추가 필요
};
